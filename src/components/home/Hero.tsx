...
export function Hero() {
  return (
    <section className="relative -mt-20 flex min-h-svh w-full items-center overflow-hidden bg-black text-white">
      ...
      <div className="pointer-events-none absolute left-[29.1%] top-[22%] z-[2] hidden lg:block" aria-hidden>
        <div
        ...
        >
          <FigmaIcon src="/figma/hero/tile-wrench.svg" width={31} height={31} flipY />
        </div>
      </div>
      <div className="pointer-events-none absolute left-[67.4%] top-[18%] z-[2] hidden md:block" aria-hidden>
        <div
        ...
        >
          <FigmaIcon src="/figma/hero/tile-battery.svg" width={31} height={31} flipY />
        </div>
      </div>
      <div className="pointer-events-none absolute bottom-[14%] left-[35.7%] z-[2] hidden md:block" aria-hidden>
        <div
        ...
        >
          <FigmaIcon src="/figma/hero/tile-bolt.svg" width={31} height={31} flipY />
        </div>
      </div>
